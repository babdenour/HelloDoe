...
export class CandidateService {
  constructor(private readonly missionClt: MissionClient, private readonly candidateClt: CandidateClient) {}
  ...
  public async refreshFavoriteDoersCount(missionId: string): Promise<void> {
    const count: number = await this.missionClt.fetchFavoriteDoersCount(missionId);

...
export class NavigationService {
  ...
  public goToSponsoTypeform = (): void => {
    window.open('https://hellodoe.typeform.com/to/IYc8o9Cp', '_blank');
  };

  public goToBoostTypeform = (): void => {
    window.open('https://hellodoe.typeform.com/to/h90HHrIF', '_blank');
  };

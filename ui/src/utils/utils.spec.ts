  ...
  describe(`moveDown`, () => {
    describe(`if item not last`, () => {
      it(`should move item down`, async () => {
        expect(moveDown(['1', '2'], (str) => str === '1')).toEqual(['2', '1']);
      });
    });

    describe(`if item last`, () => {
      it(`should do nothing`, async () => {
        expect(moveDown(['2', '1'], (str) => str === '1')).toEqual(['2', '1']);
      });
    });
  ...
  describe(`moveUp`, () => {
    describe(`if item not first`, () => {
      it(`should move item up`, async () => {
        expect(moveUp(['2', '1'], (str) => str === '1')).toEqual(['1', '2']);
      });
    });

    describe(`if item first`, () => {
      it(`should do nothing`, async () => {
        expect(moveUp(['1', '2'], (str) => str === '1')).toEqual(['1', '2']);
      });
    });
  });
});

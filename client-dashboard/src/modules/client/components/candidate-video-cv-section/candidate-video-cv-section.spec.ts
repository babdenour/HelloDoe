...
describe('CandidateVideoCvSection', () => {
  ...
  describe('when display candidate info', () => {
    ...
    it('should hide unlocked info', () => {
      const infoUnlocked: Wrapper<Vue> = find(wrapper, INFO_UNLOCKED_SELECTOR);

      expect(infoUnlocked.exists()).toBe(false);
    });

    describe('when candidate unlocked', () => {
      beforeEach(() => {
        mockCandidateStatus = CandidateStatus.UNLOCKED;
        createWrapper();
      });

      it('should display unlocked info', () => {
        const infoUnlocked: Wrapper<Vue> = find(wrapper, INFO_UNLOCKED_SELECTOR);

        expect(infoUnlocked.exists()).toBe(true);
      });

      it('should display phone', () => {
        const phone: Wrapper<Vue> = find(wrapper, INFO_PHONE_SELECTOR);

        expect(phone.text()).toBe(PHONE);
      });

      it('should display email', () => {
        const email: Wrapper<Vue> = find(wrapper, INFO_EMAIL_SELECTOR);
  ...
  describe('when user is unlocked', () => {
    beforeEach(() => {
      mockCandidateStatus = CandidateStatus.UNLOCKED;
      createWrapper();
    });

    it('should not display heart button', () => {
  ...
  describe('when user is not unlocked', () => {
    beforeEach(() => {
      mockCandidateStatus = CandidateStatus.OTHER;
      createWrapper();
    });
